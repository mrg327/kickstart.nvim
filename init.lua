...
I would be nothing without your work. You have paved the way for many devs.
...
-- UndoTreeKeybinds
-- TODO: Move this into the plugin file
vim.keymap.set('n', '<leader>U', '<cmd>UndotreeToggle<CR>', { desc = 'Move focus to the upper window' })
...
-- Auto-save markdown files after 3 seconds of inactivity
vim.api.nvim_create_autocmd({ "CursorHold", "CursorHoldI" }, {
  ...
  desc = "Auto-save markdown files after 3 seconds of inactivity",
})
